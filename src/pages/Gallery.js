    ...
    constructor() {
        ...
        this.state = {
            buku: [
                ...
                {
                    isbn: "12347", judul: "Burlian", penulis: "Tere Liye", penerbit: "CV Nusa Bangsa", harga: 80000,
                    cover: "https://i2.wp.com/julismail.staff.telkomuniversity.ac.id/files/2016/09/Bildschirmfoto-2016-09-25-um-06.08.40.png?fit=383%2C574&ssl=1"
                },
            ],
            action: "",
            isbn: "",
                            ...
                            <div className="modal-body">
                                <form onSubmit={ev => this.Save(ev)}>
                                    ...
                                    <input type="text" className="form-control mb-2"
                                        ...
                                        value={this.state.penerbit} onChange={ev => this.setState({ penerbit: ev.target.value })} required />
                                    Harga Buku
